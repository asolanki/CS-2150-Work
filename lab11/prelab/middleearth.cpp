...
/** 
 * the names of all of the possible cities in Middle-Earth
 */
 ...
 *
 *  Sauron, the destructor of Middle-Earth, destroys the instance of Middle-Earth.
 */
...
/**
 * @brief prints cities to console
 *
 * The mouth of Sauron describing Middle-Earth
 *
 */
...
/**
 * @brief prints table of distances to console
 *
 * creates a tab-separated table of the distances between the cities (can be loaded into Excel etc.)
 *
 */
...
/**
 * @brief returns distance between two cities
 *
 * Fetches and returns the distance between two cities from the distances array
 * @return float distance between the two cities
 ...
 * @param length number of cities not including the start/end point
 */
